...
| [Upstream Changes Watcher](../workflows/upstream-changes-watcher.md) | Weekly report that compares configured upstream sources, highlights meaningful changes, and opens one rolling issue with the latest findings. | pull_request |
